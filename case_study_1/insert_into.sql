...
insert into employee_level(employee_level_name)
values ('Trung Cấp'),('Cao Đẳng'),('Đại Học'),('Sau Đại Học');

insert into department(department_name)
values ('Sale-Marketing'),('Hành chính'),('Phục vụ'),('Quản lý');

insert into employee(full_name, date_of_birth, passport, salary, phone_number, email, address, role_id, employee_level_id, department_id)
values 
 ('Nguyễn Văn An','1970-11-07','456231786',10000000,'0901234121','annguyen@gmail.com','295 Nguyễn Tất Thành, Đà Nẵng',1,3,1),
  ...
  insert into customer(full_name,date_of_birth,gender,passport,phone_number,email,address,customer_type_id)
  values
...
insert into rentail_type(rentail_type_name)
values ('year'),('month'),('day'),('hour');

insert into type_of_service(type_of_service_name)
values ('Villa'),('House'),('Room');

insert into other_service(other_service_name,price,unit,status)
values 
...
insert into service(service_name,area_of_facility,rentail_fee,max_people,standard,info,area_of_swimming_pool,number_of_floor,rentail_type_id,type_of_service_id)
values 
 ...
 insert into contract_detail(quantity,contract_id,other_service_id)
  values
    (5,2,4),
  (8,2,5),
  (15,2,6),
